<nav class="sb-topnav navbar navbar-expand-lg navbar-light bg-white shadow-sm">
    <img src="{{ asset('img/logo.png') }}" alt="Logo Anda" style="height: 40px; margin-right: 10px;">
    </a>

    <button class="btn btn-link btn-md order-1 order-lg-0" id="sidebarToggle" href="#">
